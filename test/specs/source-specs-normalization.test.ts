...
const PURPOSE_PLACEHOLDER_PATTERN = /TBD(archive): describe what this capability is for and replace this line — created by archiving change .*?\. Update Purpose after archive\./;
