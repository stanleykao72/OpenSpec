...
`;
      ...
      expect(updatedContent).not.toContain('TBD(archive):');
...
`;
      ...
      expect(updatedContent).toContain(
        `TBD(archive): describe what this capability is for and replace this line — created by archiving change ${changeName}.`
      );
    });
