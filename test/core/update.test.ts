...
`;
    ...
    it('should update core profile skill files when tool is configured', async () => {
      ...
      // Verify core profile skill files were created/updated (propose, explore, apply, verify, sync, archive)
  ...
  describe('command updates', () => {
    ...
    it('should update core profile opsx commands when tool is configured', async () => {
      ...
      // Verify core profile commands were created (propose, explore, apply, verify, sync, archive)
      const coreCommandIds = ['explore', 'apply', 'verify', 'sync', 'archive', 'propose'];
      const commandsDir = path.join(testDir, '.claude', 'commands', 'opsx');
